<h2><a href="https://leetcode.com/problems/check-if-every-row-and-column-contains-all-numbers/?envType=problem-list-v2&envId=hash-table">2254. Check if Every Row and Column Contains All Numbers</a></h2><h3>Easy</h3><hr><p>An <code>n x n</code> matrix is <strong>valid</strong> if every row and every column contains <strong>all</strong> the integers from <code>1</code> to <code>n</code> (<strong>inclusive</strong>).</p>
